...
phases = [
    ...
    f"(Midnight)Towards the goal of improving on {possessive_pronoun} independent living skills, {name} was able to sleep the entire night without interruptions. Staff periodically checked on {object_pronoun} and observed no needs throughout the night. Staff will continue to be available, should {subject_pronoun} have any needs to improve {possessive_pronoun} independent living skills."
]
